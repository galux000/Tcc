    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult LogOff()
        {
            ...
            if (Session["facebooktoken"] != null)
            {
                ...
                var logoutUrl = fb.GetLogoutUrl(new { access_token = accesstoken, next = "http://localhost:52303" });
        ...
        public ActionResult ExternalLoginCallback(string returnUrl)
        {
            ...
            if (result.ExtraData.Keys.Contains("accesstoken")) { Session["facebooktoken"] = result.ExtraData["accesstoken"]; }
            ...
            if (ModelState.IsValid)
            {
                ...
                using (UsersContext db = new UsersContext())
                {
                    ...
                    if (user == null)
                    {
                        ...
                        var currentUser = Membership.GetUser(User.Identity.Name);
                        var userContext = db.UserProfiles.Where(u => u.UserName == model.UserName).First();
